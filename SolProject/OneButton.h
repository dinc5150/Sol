...
public:
	// ----- Constructor -----
	OneButton(int pin, int active, Trigger *MasterTrigger);
	...
	Trigger *_masterTrigger; //This is the master trigger for the button
...
private:
	...
	static const int _debounceTicks = 50; // number of ticks for debounce times.
